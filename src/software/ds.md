...
Linked above is the official download link of the FirstDriverStation, this application needs to be updated manually (As of August 1st 2026). Download the version that matches with your operating system and processing unit, it is listed on the github release page below.
...
[Diagram of Driver Station](images/DriverStation.png)
...
[Diagram of Main Control Panel](images/MainControlPanel.png)
...
[Settings Part 1](images/settingsp1.png)
...
[Settings Part 2](images/settingsp2.png)
When we scroll down to this part, make sure that you reset the Robot Code anytime you update or pull code from the github. Then make sure that you always reset times to the FRC standard (because we are in FRC :D). Leave everything unchecked unless necessary or directed too.
Official Resources
